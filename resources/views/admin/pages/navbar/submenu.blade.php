          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary" id="navbar-form-container" style="display:none">
              <div class="card-header">
                <h4 class="card-title" id="navbar-form-title">Add Sub Menu</h4>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="navbar-form" enctype="multipart/form-data">
                ...
                <input type="text" name="parent_nav_id" id="parent_nav_id" value="{{ $navbar->id }}" hidden>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
            ...
            <div class="card" id="navbar-data-container">
              <div class="card-header">
                <h3 class="card-title">Manage Sub Menu Of {{ Str::ucfirst($navbar->title) }}</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6 col-md-6">
                    <button class="btn btn-primary" id="add-navbar-btn"><i class="fa fa-plus"></i> Add Sub Menu</button>
...
$(document).ready(function() {
  ...
  $("#add-navbar-btn").click(function() {
    $("#navbar-form-title").html("Add Sub Menu");
  ...
  $("#navbar-data-container").on("click", ".edit-navbar-btn", function() {
    ...
    $.ajax({
      ...
      success: async function(res) {
        // Hide preloader
        $.LoadingOverlay("hide");
        $("#navbar-form-title").html("Update Sub Menu");
